    ...
    public class UtenteController {
        ...
        public String postForm(@ModelAttribute Utente utente, Model model) {
            ...
            // Controllo input POST esterni
            if (utente.getNome() == null) {
                errori.add("Errore. Il campo Nome è vuoto.");
            }
            if (utente.getEmail() == null) {
                errori.add("Errore. Il campo Email è vuoto.");
            }
            if (utente.getPassword() == null) {
                errori.add("Errore. Il campo Password è vuoto.");
            }
            if (utente.getConfermaPassword() == null) {
                errori.add("Errore. Il campo Conferma Password è vuoto.");
            }
            if (utente.getDataDiNascita() == null) {
                errori.add("Errore. Il campo Data di Nascita è vuoto.");
            }
            if (utente.getTelefono() == null) {
                errori.add("Errore. Il campo Telefono è vuoto.");
            }

            // Se non ci sono dati null, continua il codice
            if (errori.isEmpty()) {
